...
def test_real_bge_m3_embed_store_query_roundtrip(tmp_path):
    ...
    store.upsert([
        {"vector": vecs[0], "text": "虚拟内存", "ingest_record_id": 1, "project_id": 1,
         "char_start": 0, "char_end": 4, "source_type": "folder_scan", "embed_model_id": emb.model_id, "capture_session_id": 0, "ts": ""},
        {"vector": vecs[1], "text": "量子色动力学", "ingest_record_id": 2, "project_id": 1,
         "char_start": 0, "char_end": 6, "source_type": "folder_scan", "embed_model_id": emb.model_id, "capture_session_id": 0, "ts": ""},
    ])
    q = emb.embed(["虚拟内存"])[0]
